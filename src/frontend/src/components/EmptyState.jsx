    ...
    <div className="flex h-screen flex-col">
      ...
      <div className="flex flex-1 items-center justify-center overflow-y-auto px-[24px] py-[64px]">
        <div className="w-full max-w-[700px]">
          ...
          {/* ── Title ── */}
          <h1 className="font-sans text-[48px] font-bold text-[#0F172A] text-center">
            CourseFlow
          </h1>

          {/* ── Tagline ── */}
          <p className="mx-auto mt-[12px] max-w-[500px] text-[18px] font-normal text-[#475569] text-center">
